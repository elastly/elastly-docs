...
Cost is $1.00. The numbers are illustrative.

| Step                       | Adjustment |
| -------------------------- | ---------- |
| Category margin (bearings) | +30%       |
| Segment adjustment (dealer) | +5%       |
| Region adjustment (West Africa) | −6%   |
| Cost trend (rising)        | +1%        |
| Learned adjustment         | +0.5%      |
| **Target margin**          | **30.5%**  |
| **Price** (after rounding) | **$1.30**  |
