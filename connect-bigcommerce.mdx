...
<Steps>
  ...
  <Step title="Grant the access it needs">
    ...
    <Frame caption="The API account scopes. Products needs Modify for write-back; the rest are read-only.">
      <img src="/art/bigcommerce-scopes.png" alt="BigCommerce store-level API account scopes: Products Modify, Orders read-only, Customers read-only, Information and settings read-only." />
    </Frame>
