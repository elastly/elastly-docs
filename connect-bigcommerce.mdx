...
Log in to your BigCommerce control panel and read it straight off the address bar. In a URL like
...
<Steps>
  <Step title="Open Integrations">
    In Elastly, open **Integrations** and press **Connect BigCommerce**.
  </Step>
