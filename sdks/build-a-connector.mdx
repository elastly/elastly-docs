...
<Columns cols={2}>
  <Card title="The connector framework" icon="bolt" href="/sdks/build-a-connector/connector-framework">
...
The [connector framework](/sdks/build-a-connector/connector-framework) sets up its own client, so this
