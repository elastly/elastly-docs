...
Connect **Custom ERP** or **Custom Storefront** under **Integrations**, then create a **Connector** API
key under **Settings → API keys** and send it as a bearer token on every request.
