...
1. In the dashboard, open **Integrations** and connect **Custom ERP** or **Custom Storefront**. There
   are no credentials to paste. Custom ERP accepts quotes; Custom Storefront is catalog and orders
   only.
2. Under **Settings → API keys**, create a key with the **Connector** scope, and send it as a bearer
