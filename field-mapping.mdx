...
<Columns cols={3}>
  <Card title="Verified" icon="circle-check" horizontal>
    Elastly is confident. Nothing for you to do.
  </Card>
  <Card title="Review" icon="triangle-exclamation" horizontal>
    Your call. A close second candidate, or a weaker match.
  </Card>
  <Card title="Not mapped" icon="circle-minus" horizontal>
    No candidate was good enough to guess.
  </Card>
</Columns>
