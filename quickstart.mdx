...
<Steps titleSize="h2">
  <Step title="Connect your data">
    ...
    <Columns cols={2}>
      <Card title="Oracle NetSuite" icon="/logos/netsuite.svg" href="/connect-netsuite">
        Set up once by an administrator. Also syncs quotes.
      </Card>
      <Card title="Shopify" icon="/logos/shopify.svg" href="/connect-shopify">
        A one-click install. Syncs your catalog at the variant level.
      </Card>
      <Card title="BigCommerce" icon="/logos/bigcommerce.svg" href="/connect-bigcommerce">
        Connect with a store API token.
      </Card>
      <Card title="WooCommerce" icon="/logos/woocommerce.svg" href="/connect-woocommerce">
        Connect with a consumer key and secret.
      </Card>
    </Columns>

    The first sync pulls everything, then future syncs only fetch what changed. See
    [Connectors](/connectors) for how syncing works, and for the sources coming next.
