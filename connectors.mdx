...
All four sync products, cost, customers, and orders, and all four can publish an approved price back
to the source. Write-back is off until you turn it on.
...
<Steps titleSize="h3">
  <Step title="Connect">
    ...
    API token, and WooCommerce uses a consumer key and secret. Your credentials are stored encrypted
    and scoped to your workspace.
  </Step>
